...
local INTER = hasGameFont and Addon.ClientFont.GamePath()
	or [[Interface\AddOns\AuraNameplate\Media\Fonts\Inter-Regular.ttf]]
local INTER_SEMIBOLD = hasGameFont and Addon.ClientFont.GamePath()
	or [[Interface\AddOns\AuraNameplate\Media\Fonts\Inter-SemiBold.ttf]]
local MONO = hasGameFont and Addon.ClientFont.GamePath()
	or [[Interface\AddOns\AuraNameplate\Media\Fonts\JetBrainsMono-Regular.ttf]]
...
local function Make(name, path, size)
	local font = CreateFont("AuraNameplate" .. name)

...
---
--- LibDataBroker publishes a launcher any broker display can pick up, and
--- LibDBIcon is only one consumer of it. Registering the broker rather than
--- drawing a button means the addon shows up wherever the player already
--- keeps their launchers.
---@class MinimapButton
...
--- Only the icon goes away; the broker stays published, so a data-text bar that
--- shows it keeps working.

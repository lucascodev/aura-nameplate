...
local CORE_FILES = {
	...
	"Preferences/AnchorPoints",
	"Preferences/VisibilityModes",
	"Preferences/HealthFormats",
	"Preferences/AuraFilters",
	"Preferences/PlateVisibility",
	"Preferences/Catalog",
	"Preferences/Store",
	"Preferences/Lookup",
	"LayoutBaseline",
...
function Harness.RuntimeFiles()
	local paths = {}
	local toc = assert(io.open(ADDON_NAME .. ".toc", "r"))
